...
export const GitCommitIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
...
export const GitPullRequestIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const GitMergeIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="18" cy="18" r="3" />
    <circle cx="6" cy="6" r="3" />
...
export const RefreshIcon: React.FC<IconProps & { spinning?: boolean }> = ({ size = 16, color = 'currentColor', className, spinning }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`${className || ''} ${spinning ? 'animate-spin' : ''}`} style={spinning ? { animation: 'spin 1s linear infinite' } : undefined}>
